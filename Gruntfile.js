...
module.exports = function (grunt) {
      ...
      livereload: {
        options: {
          ...
          middleware: function (connect, options) {
            ...
            var middlewares = [];
            options.base.forEach(function(base) { // static files
  ...
  grunt.registerTask('force', function (forceSwitch) {
    var switches = {
      'on': true,
      'off': false,
      'default': defaultForceState
    };
    if (switches[forceSwitch]) {
      grunt.option('force', switches[forceSwitch]);
    }
  });
